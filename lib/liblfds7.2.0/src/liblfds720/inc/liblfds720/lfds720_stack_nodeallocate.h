/***** enums *****/
enum lfds720_stack_n_query
{
  LFDS720_STACK_N_QUERY_SINGLETHREADED_GET_COUNT,
  LFDS720_STACK_N_QUERY_SINGLETHREADED_VALIDATE
};
...
struct lfds720_stack_n_state
{
  struct lfds720_stack_n_element LFDS720_PAL_ALIGN(LFDS720_PAL_ATOMIC_ISOLATION_LENGTH_IN_BYTES)
...
#define LFDS720_STACK_N_GET_KEY_FROM_ELEMENT( stack_n_element )             ( (stack_n_element).key )
#define LFDS720_STACK_N_SET_KEY_IN_ELEMENT( stack_n_element, new_key )      ( (stack_n_element).key = (void *) (lfds720_pal_uint_t) (new_key) )
#define LFDS720_STACK_N_GET_VALUE_FROM_ELEMENT( stack_n_element )           ( (stack_n_element).value )
#define LFDS720_STACK_N_SET_VALUE_IN_ELEMENT( stack_n_element, new_value )  ( (stack_n_element).value = (void *) (lfds720_pal_uint_t) (new_value) )
#define LFDS720_STACK_N_GET_USER_STATE_FROM_STATE( stack_n_state )          ( (stack_n_state).user_state )
